...
RUN         cd /home/bayeslite && git clone git@github.com:mit-probabilistic-computing-project/crosscat.git

# git clone Bayeslite
RUN         cd /home/bayeslite && git clone git@github.com:mit-probabilistic-computing-project/bayeslite.git
